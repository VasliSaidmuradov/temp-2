    ...
    <div class="get-steps">
            ...
            <div class="layout-container">
                <div class="get-steps-row">
                    <div class="get-steps-left">
                        <h3 class="section-title">Шаг 1. Выберете необходимую сумму и срок!</h3>
                        <p class="get-steps-text">Калькулятор автоматически рассчитает сумму и срок возврата, более того, будут указаны сумма вознаграждения (только для повторных займов) и сумма комиссии за верификацию. При возврате займа Вы не получите никаких сюрпризов в виде скрытых комиссий. </p>
                        <h4 class="get-steps-heading --block">
        ...
        <div class="get-steps-block --z2 --padding-bottom">
            <div class="layout-container">
                <div class="get-steps-row">
                    <div class="get-steps-left">
                        <h3 class="section-title">Шаг 4. Получение денег</h3>
                        <p class="get-steps-text">
                    ...
                    <div class="get-steps-right">
                        <img src="/img/get-steps3.png" alt="CashU image">
                    </div>
                </div>
            </div>
        </div>
